"""
Audio, Video, and Text Transforms for AVSR

Includes:
- FunctionalModule: Wraps any function as a torch.nn.Module.
- AdaptiveTimeMask: Applies random time masking for augmentation.
- AddNoise: Adds background noise at specified SNR levels.
- VideoTransform: Video preprocessing pipeline for train/val/test.
- AudioTransform: Audio preprocessing pipeline for train/val/test.
- TextTransform: SentencePiece-based tokenization and decoding.
"""
...
class FunctionalModule(torch.nn.Module):
    """Wraps any callable function into a nn.Module."""
...
# -------------------------
# Audio & Video augmentations
# -------------------------
class AdaptiveTimeMask(torch.nn.Module):
    """Randomly masks segments along the time axis for data augmentation."""
...
class AddNoise(torch.nn.Module):
    """Adds background noise to audio samples."""
...
# -------------------------
class TextTransform:
    """SentencePiece-based tokenization and decoding."""
    ...
    def __init__(self, sp_model_path=SP_MODEL_PATH, dict_path=DICT_PATH):
        ...
        # 0 is used for "blank" token in CTC
    ...
    @staticmethod
    def _ids_to_str(token_ids, char_list):
